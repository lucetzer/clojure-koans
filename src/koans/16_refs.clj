...
(meditations
  ...
  ; # means an anonymous function literal where
  ; args are determined by the presence of argument literals taking the form %, %n or %&
  ; % is a synonym for %1, %n designates the nth arg (1-based), and %& designates a rest arg
  ; % means an anonymous function argument
